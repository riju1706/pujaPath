...
import TraineeDetailsEdit from "./TraineeDetailsEdit";
import CourseCard from "./CourseCard";

export default function TrainerDashboarda() {
      ...
      <Paper>
        <Stack direction="row">
          ...
          >
            ...
            {/* {dashboardTab == 2 && <PanditBookings />}
            {dashboardTab == 3 && <Booked />}
            {dashboardTab == 4 && <Reviews />} */}
          </Box>
        </Stack>
      </Paper>
      <Box>
