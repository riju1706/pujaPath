...
export default function DevoteeBookingsCard({
  pandit,
  puja,
  date,
  time,
  ...
  return (
    ...
    >
      <Box
        sx={{
          display: "grid",
          gridTemplateColumns: "1fr 2fr 2fr 2fr 2fr 2fr 4fr",
          marginBottom: "1.5rem",
          alignItems: "center",
        }}
      >
        ...
        <Typography variant="body1">
          {pandit.fName} {pandit.lName}
        </Typography>
        <Typography variant="body1">{puja} Puja </Typography>
